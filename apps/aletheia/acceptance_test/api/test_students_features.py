...
from apps.aletheia.api.routers import students, courses, faculties, iam
...
class StudentsControllerShould(TestFastapiServer):
    ...
    async def pre_create_student(self, student_id: str, email: str, password: str):
    ...
    async def test_put_enrolled_course_on_student(self):
        ...
        await self.pre_create_student(student_id, email, password)
