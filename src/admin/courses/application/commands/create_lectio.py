...
from src.admin.courses.domain.entities import Lectio
...
from src.admin.courses.domain.value_objects import LectioName, LectioDescription
from src.shared.domain.ddd.errors import EntityNotFoundError
