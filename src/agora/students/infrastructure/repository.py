...
from src.agora.students.domain.entities import Student, Faculty
from src.agora.students.domain.repository import StudentRepository
from src.agora.students.domain.value_objects import LectioStatus, Name, Surnames
...
class StudentDataMapper(DataMapper):
    ...
    def persistence_model_to_entity(self, instance: StudentModel) -> Student:
        ...
        def enrolled_course_model_to_entity(instance: StudentEnrolledCourseModel) -> Course:
